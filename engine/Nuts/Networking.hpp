...
public:
    ...
    bool NetConnect(sf::IpAddress serverIp, int serverPort)
    {
    ...
    void UdpSend(EventType type, sf::Packet &packet)
    {
        if (!_isConnected) return;
    ...
    void SetRemoteGameEndpoint(sf::IpAddress &serverIp, std::uint16_t serverPort)
    {
